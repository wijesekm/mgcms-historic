...
$sql_config="";
$sql_config["SQL_TYPE"]="{sqltype}";
$sql_config["SQL_HOST"]="{sqlhost}";
$sql_config["SQL_PORT"]="{sqlport}";
$sql_config["SQL_SOCKET"]="{sqlsocket}";
$sql_config["SQL_USER"]="{sqluser}";
$sql_config["SQL_PASSWORD"]="{sqlpass}";
$sql_config["SQL_DATABASE"]="{sqldb}";
$sql_config["TABLE_PREFIX"]="{sqlprefix}";
$sql_config["USE_SSL"]={usessl};
$sql_config["SSL"]={ssl}
...
//	
$adldap_config="";
$adldap_config["DN"]="{ldapdn}";
$adldap_config["DC"]={ldapdc};
$adldap_config["ACCT_SUFFIX"]="{ldapacctsuffix}";
$adldap_config["CONTROL_USER"]="{ldapcuser}";
$adldap_config["CONTROL_PASSWORD"]="{ldapcpass}";
...
$log_config="";
$log_config["LOG_LEVEL_1"]={loglvl1};
$log_config["LOG_LEVEL_2"]={loglvl2};
$log_config["ARCHIVE"]="{logarchive}";
...
$GLOBALS["MANDRIGO"]["CONFIG"]["ROOT_PATH"]="{root_path}";
$GLOBALS["MANDRIGO"]["CONFIG"]["PLUGIN_PATH"]="{plugin_path}";
$GLOBALS["MANDRIGO"]["CONFIG"]["TEMPLATE_PATH"]="{template_path}";
$GLOBALS["MANDRIGO"]["CONFIG"]["LOG_PATH"]="{log_path}";
$GLOBALS["MANDRIGO"]["CONFIG"]["IMG_PATH"]="{img_path}";
$GLOBALS["MANDRIGO"]["CONFIG"]["TMP_PATH"]="{tmp_path}";
$GLOBALS["MANDRIGO"]["CONFIG"]["ADMIN_ROOT_PATH"]="{admin_path}";
$GLOBALS["MANDRIGO"]["CONFIG"]["LOGIN_ROOT_PATH"]="{login_path}";
...
//
$GLOBALS["MANDRIGO"]["CONFIG"]["IS_INSTALLED"]={is_installed};
...
//
//HTML_VER - html version that the script is in (ex xhtml_1_0_trans)
//


$GLOBALS["MANDRIGO"]["CONFIG"]["LANGUAGE"]="{lang}";
$GLOBALS["MANDRIGO"]["CONFIG"]["HTML_VER"]="{html}";
