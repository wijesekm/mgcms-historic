...
if($GLOBALS["SITE_DATA"]["URL_FORMAT"] == 0){
    ...
    $GLOBALS["HTTP_GET"]["KEY"]  = (isset($HTTP_GET_VARS["k"]))?clean_password($HTTP_GET_VARS["k"]):DEFAULT_KEY;
    ...
    $GLOBALS["HTTP_GET"]["KEY"] = (isset($url["k"]))?clean_password($url["k"]):DEFAULT_KEY;
