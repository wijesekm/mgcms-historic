...
class media_gallery_hook{
    function media_gallery_display_hook(&$sql,$i){

    }
    function media_gallery_vars_hook(&$sql,$i){

    }
    function media_gallery_admin_hook(&$sql,$i){
